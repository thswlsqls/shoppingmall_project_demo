		...
		$.ajax({
			...
			success: function(rep){
				...
				rep.forEach(function(data){
					...
					html += "<div align='left'><b>아이디 : </b>"+data.noticeWriterId+"님 / ";
...
#first{
	...
	top:100px; left: 0; right: 0; width: 600px;  height:600px;
...
<div class="content">
	...
	<div class="wrap">
		<table class="table table-bordered">
			<tr>
				<th style="background: Lightgray; ">No.1</th>
				<th colspan="3">${personalData.noticeId }</th>
			</tr>
			<tr>
				<th style="background: Lightgray;" >Writer</th>
				<th colspan="3">${personalData.noticeWriterId }</th>
			</tr>
			<tr>
				<th style="background: Lightgray;">Writer Date</th>
				<th colspan="3">${personalData.noticeCreateDate }</th>
			</tr>
			<tr>
				<th style="background: Lightgray;" >Title</th>
				<th colspan="3">${personalData.noticeTitle }</th>
				
			</tr>
			<tr>
				<th colspan="4" style="background: Lightgray;">Content</th>
			</tr>
			<tr>
			...
			<tr>
				...
				<input type="button" class="btn btn-outline-success" onclick="location.href='${contextPath }/notice/noticeAllList'" value="목록"></td>
			</tr>
		</table>
	</div>
