...
/* 	a:link { text-decoration: none; border: 1px solid;}
	a:visited { text-decoration: none; border: 1px solid red;} */
	.product a { color: black; }
	.product a:hover { color: gray; }
	#paging{  }
...
<div class="content"> 				
	<div class="aside">
		<div class="kategorie">
			...
			<div class="ka">
			<h6><b>수제간식</b></h6><hr>
			<input type="checkbox" id="all" name="kategorie" value="all" onclick="movepage('http://localhost:8080/root/product/allview');"> All <br>
			<input type="checkbox" id="dog" name="kategorie" value="dog" onclick="movepage('http://localhost:8080/root/product/dogview/dog');"> 강아지<br>
			<input type="checkbox" id="cat" name="kategorie" value="cat" onclick="movepage('http://localhost:8080/root/product/catview/cat');"> 고양이<br>
			</div>
		</div>
		<div class="product">
			<br><br>
			<h3>A L L</h3><br><hr><br>
					...
					<a href="${contextPath }/product/productdetail/${dto.productId}">
						<div class="pr" style="background:#f5f5f5; margin-left:10px; width:95%;"><br>
							<img alt="이미지가 없습니다" width="100px" height="100px"
								src="<tags:url value='/resources/img/${dto.productName}.jpg'/>">
							<div>상품명 : ${dto.productName }</div>
							<div>가격 : ${dto.productSalePrice }</div>
