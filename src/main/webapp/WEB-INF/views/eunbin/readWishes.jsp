...
<body >
	...
	<div class="content">
		...
		<div class="section">
	     ...
	     <br>
	     <div>
	      	<button type="button"  id="wishDeleteBtn" class="btn btn-outline-secondary margin10px floatLeft" >삭제</button>
	      	<button type="button" class="btn btn-outline-secondary margin10px floatLeft">장바구니 담기</button>
	      	<button type="button" style="width: 300px;" class="btn btn-outline-secondary margin10px floatRight">주문하기</button>
	     </div>
 		</div>
 	</div>
 	</div>	
